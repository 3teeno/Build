...
class Active_Orders_Page_Vendor extends StatefulWidget {
  const Active_Orders_Page_Vendor({Key key}) : super(key: key);

  @override
  State<Active_Orders_Page_Vendor> createState() => _Active_Orders_Page_VendorState();
}
class _Active_Orders_Page_VendorState extends State<Active_Orders_Page_Vendor> {
  List<Order> orders = [];
  List mydocs = [];
  Future<void> initialise() async {
    await Order.fetch_vendor_order(currentUser.user.uid).then ((value) => setState((){ mydocs=value; } ) );
